<template>
	...
	<view>
		<view class="nav">
			<view class="column" @click="Show" :class="{active:currentType==0||currentType==3||currentType==4}">综合
				<text class="flicon">&#xe601;</text>
			</view>

			<view class="column" @click="clickXL" :class="{active:currentType==6}">销量</view>
