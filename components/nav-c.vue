<template>
	...
	<view>
		<view class="nav">
			<view class="column" @click="Show" :class="{active:currentType==0||currentType==5||currentType==4}">综合
				<text class="flicon">&#xe601;</text>
			</view>

			<view class="column" @click="clickXL" :class="{active:currentType==2}">销量</view>

			<view class="column yongjin" @click="clickYJ" :class="{active:currentType==3}">佣金
				<!-- <view class="icon-sx">
