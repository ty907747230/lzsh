...
<script>
	...
	import Nav from "@/components/nav-p.vue";
	import ShopListOne from "@/components/shop-news-p.vue"; //单列
	import ShopListTwo from "@/components/shop-two-p.vue"; //双列
	...
	export default {
		...
		methods: {
			...
			getType(data) {
				...
				this.$api.pdd_goods_list(this.pageno, this.pagesize,data.type, this.youquan,this.keywords).then(res => {
